  ...
  <div class="bg center"></div>
    ...
    <div class="jumbotron">
      ...
      <div class="custom-container">
        ...
        <ul id="countdown">
          ...
          <li>
            ...
            <div class="textDays">Gün</div>
          </li>

          <li>
            <div class="hours">00</div>
            <div class="textHours">Saat</div>
          </li>

          <li>
            <div class="minutes">00</div>
            <div class="textMinutes">Dakika</div>
          </li>

          <li>
            <div class="seconds">00</div>
            <div class="textSeconds">Saniye</div>
          </li>
      ...
      <div class="container fc_social_part">
        <!-- Title -->
        <h2 class="title-contact">Sosyal Aglar ve iletisim!</h2>
